...
object IdrisRootResolver {
    ...
    fun rootFor(project: Project, file: VirtualFile): Path {
        ...
        if (contentRoot != null) return Paths.get(contentRoot.path)
        return Paths.get(file.parent?.path ?: project.basePath ?: ".")
    }
